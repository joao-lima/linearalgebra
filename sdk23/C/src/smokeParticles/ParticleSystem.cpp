...
ParticleSystem::ParticleSystem(uint numParticles, bool bUseVBO) :
...
ParticleSystem::_initialize(int numParticles)
{
	...
	m_radixSort = new RadixSort(numParticles);
...
ParticleSystem::depthSort()
{
    ...
    // radix sort
	m_radixSort->sort(m_sortKeys.getDevicePtr(), m_indices.getDevicePtr(), m_numParticles, 32, true);
